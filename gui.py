...
def run_gui() -> None:
    root = tk.Tk()
    root.title("Coop Promo Data Transformer")
    ...
    tk.Label(root, text="Step 1: Choose Coop Promo Excel file (.xlsx)").pack(pady=5)
    ...
    tk.Button(
        root,
        text="Step 3: Convert and Save File",
    ...
    tk.Label(
        root,
        text="Coop Promo Transformer - anonymises and cleans hotel data export for analysis.",
        fg="gray",
    ).pack(pady=10)
